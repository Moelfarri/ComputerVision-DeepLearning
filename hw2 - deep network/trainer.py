...
class BaseTrainer:
    ...
    def train(
        ...
        for epoch in tqdm(range(num_epochs)): #remove tqdm if you do not have library
            ...
            for X_batch, Y_batch in iter(train_loader):
                ...
                if global_step % num_steps_per_val == 0:
                    ...
                    if early_stop_counter >= 50: 
                        ...
                        #remove comment to have early_stopping/comment out return to remove earlystopping
