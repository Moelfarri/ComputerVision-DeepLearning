...
if __name__ == "__main__":
    ...
    ######3nd model - network from task 4e ######
    ...
    plt.subplot(1, 2, 2)
    plt.ylim([0.91, 1.01])
    utils.plot_loss(train_history2["accuracy"], "Train - 10 hidden layers")
    utils.plot_loss(train_history1["accuracy"], "Train - 2 hidden layers")
    utils.plot_loss(train_history["accuracy"], "Train - 1 hidden layer")
    utils.plot_loss(val_history2["accuracy"],"Validation - 10 hidden layers")
    ...
    plt.legend()
    plt.savefig("task4e_training_accuracy_comparison.png")
    plt.show()
